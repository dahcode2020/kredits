...
/**
 * Espace connecté — slice 4. Atterrissage après connexion/inscription : profil, demandes locales
 * déposées depuis la slice 3, déconnexion. Le tableau de bord complet (échéanciers, paiements)
 * reste la slice 5 — rien n'est promis à l'écran avant d'exister.
 */
...
export default function AccountRoute({ params }: { params: { locale: string } }) {
  ...
  return <AccountPage locale={params.locale as Locale} />;
}
