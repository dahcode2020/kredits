...
const ROUTES = (drapeau("routes") ? process.argv.slice(process.argv.indexOf("--routes") + 1).filter((a) => !a.startsWith("--")) : ["/fr", "/en", "/nl", "/de", "/fr/credit/simulator", "/en/credit/simulator", "/nl/credit/simulator", "/de/credit/simulator", "/fr/credit/apply", "/en/credit/apply", "/nl/credit/apply", "/de/credit/apply", "/fr/auth", "/en/auth", "/nl/auth", "/de/auth", "/fr/account", "/en/account", "/nl/account", "/de/account", "/fr/offline", "/en/offline", "/nl/offline", "/de/offline"]);
